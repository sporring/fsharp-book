...
A trick to designing recursive algorithms is to \advice{assume that the recursive function already works}. Reconsider the Divide-by-two algorithm in \Cref{sec:divideByTwo}. The algorithm consists of two elements. Given an initial unsigned integer \lstinline{n}:
\begin{enumerate}
