...
WinForms is designed for \idx{event driven programming}, meaning that at run-time, most time is spend on waiting for the user to perform an action, called an \idx{event}, and each possible event has a predefined response to be performed. 
...
To display a graphical user interface on the screen, the first thing to do is open a window, which acts as a reserved screen-space for our output. In WinForms windows are called \idx{forms}. Code for opening a window is shown in Listing~\ref{lst:openWindow}, and the result is shown in Figure~\ref{fig:openWindow}.
%
\fsCode{winforms/openWindow}{lst:openWindow}{Create the window and turn over control to the operating system.}{}
%
%
...
%
\fsCode{winforms/windowAttributes}{winforms/windowAttributes}{Create the window and changing its properties.}{}
%
\begin{figure}
  \centering
...
%
\fsCode{winforms/triangle}{winforms/triangle}{Adding line graphics to a window.}{}
%
\begin{figure}
  \centering
...
%
\fsCode{winforms/triangleOrganized}{winforms/triangleOrganized}{Improved organization of code for drawing a triangle. Compare with Listing~\ref{winforms/triangle}.}{}
%
\begin{figure}
  \centering
...
%
\fsCode{winforms/rotationalSymmetry}{winforms/rotationalSymmetry}{Create the window and changing its properties. See Listing~\ref{winforms/transformWindowsTop} for top part of the code.}{firstnumber=44,firstline=44}
%
\begin{figure}
  \centering
...
%
\fsCode{winforms/hilbert}{winforms/hilbert}{Create the window and changing its properties.  See Listing~\ref{winforms/transformWindowsTop} for top part of the code.}{firstnumber=44,firstline=44}
%
\begin{figure}
  \centering
...
%
\fsCode{winforms/windowEvents}{winforms/windowEvents}{Catching window, mouse, and keyboard events.}{}
%
\fsOutput{winforms/windowEvents}{winforms/windowEvents}{Output from an interaction with the program in Listing~\ref{winforms/windowEvents}.}
%
...
%
\fsCode{winforms/buttonControl}{winforms/buttonControl}{Create the button and an event.}{}
%
\begin{figure}
  \centering
...
%
\fsCode{winforms/flowLayoutPanel}{winforms/flowLayoutPanel}{Create a FlowLayoutPanel, with checkbox and radiobuttons.}{lastline=34}
%
%
\fsCode{winforms/flowLayoutPanel}{winforms/flowLayoutPanel}{Create a FlowLayoutPanel, with checkbox and radiobuttons.}{firstline=36,firstnumber=36}
%
\begin{figure}
  \centering
...
%
\fsCode{winforms/flowLayoutPanelAdvanced}{winforms/flowLayoutPanelAdvanced}{Create nested FlowLayoutPanel, see Listing~\ref{winforms/flowLayoutPanelAdvancedTop}.}{firstline=44,firstnumber=44}
%
\begin{figure}
  \centering
...
%
\fsCode{winforms/clock}{winforms/clock}{\dots}{}
%
\begin{figure}
  \centering
