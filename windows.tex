...
%
\fsCode{winforms/openWindow}{winforms/openWindow}{Create the window and turn over control to the operating system.}{}
%
%
...
\fsCode{winforms/transformWindows}{winforms/transformWindows}{Code for drawing triangles. Continued from Listing~\ref{winforms/transformWindowsTop}.}{firstnumber=44,firstline=44}
%
\begin{figure}
  \centering
...
%
\fsCode{winforms/rotationalSymmetry}{winforms/rotationalSymmetry}{Create the window and changing its properties. Continued from Listing~\ref{winforms/transformWindowsTop}.}{firstnumber=44,firstline=44}
%
\begin{figure}
  \centering
...
%
\fsCode{winforms/hilbert}{winforms/hilbert}{Create the window and changing its properties.  Continued from Listing~\ref{winforms/transformWindowsTop}.}{firstnumber=44,firstline=44}
%
\begin{figure}
  \centering
...
%
\fsOutput{winforms/windowEvents}{winforms/windowEvents}{Output from an interaction with the program in Listing~\ref{winforms/windowEventsCode}.}
%
...
%
%
\fsCode{winforms/flowLayoutPanel}{winforms/flowLayoutPanel}{Create a FlowLayoutPanel, with checkbox and radiobuttons. Continued from Listing~\ref{winforms/flowLayoutPanelTop}.}{firstline=36,firstnumber=36}
%
\begin{figure}
  \centering
...
%
\fsCode{winforms/flowLayoutPanelAdvanced}{winforms/flowLayoutPanelAdvanced}{Create nested FlowLayoutPanel. Continued from Listing~\ref{winforms/flowLayoutPanelAdvancedTop}.}{firstline=44,firstnumber=44}
%
\begin{figure}
  \centering
...
\jon{Husk repaint, og hvordan sletter man?}
%%% Local Variables:
