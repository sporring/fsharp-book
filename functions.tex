...
Arguments need not always be inferred to types, but may be of generic type. F\# prefers this, when \idx{type safety} is ensured, e.g.,
%
...
******
\jon{nested scope, must return a value.}
