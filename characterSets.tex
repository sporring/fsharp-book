...
The general category is used to specify valid characters that not necessarily have a visual representation but possibly transforms text. Some categories and their letters in the first 256 code points are shown in \Cref{tab:generalCategories}.
\begin{table}[h]
  \centering
