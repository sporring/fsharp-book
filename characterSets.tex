...
The general category is used in grammars to specify legal characters, e.g., in naming identifiers in F\#. Some categories and their letters in the first 256 code points are shown in Table~\ref{tab:generalCategories}.
\begin{table}
  \centering
