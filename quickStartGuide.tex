...
%
\fsOutput{blocksNNamesError}{Inside a block, names may not be reused.}
% \begin{lstlisting}[language=fsharp,caption=fsharpi]
%   > let a = 357 - let a = 864;;
...
%
\fsOutput{typesNBlockInference}{Defining a function together with its use, makes F\# infer the appropriate types.}
% \begin{lstlisting}[language=fsharp,caption=fsharpi]
% > let sum x y = x + y
% - let c = sum 357.6 863.4;;
