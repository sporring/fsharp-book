...
The \idx{dot notation} is an example of Structured programming, where technically speaking, the string \lstinline|"abcdefg"| is an immutable \idx{object} of \idx{class} \lstinline|string|, and \lstinlin<e|[]| is an object \idx{method} and \lstinline|Length| is a property. For more on object, classes, and methods see Chapter~\ref{chap:oop}.  
