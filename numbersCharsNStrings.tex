...
Table~\ref{tab:preNInfixOperators} gives examples of how to use the operators for integers and floats, and most work like a standard calculator would.
...
%   \end{lstlisting}
\item[\texttt{op / op}, \texttt{op \% op}:] These are binary operators, and division performs integer division, where the fractional part is discarded after division, and the \lstinline|\%| is the remainder operator, which calculates the remainder after integer division,
%
