...
\section{Introduction}
  \idx[imperativ programming]{Imperativ programming} focusses on how a problem is to be solved as a list of \idx[statement]{statements} and and a set of \idx{states}, where states may change over time. An example is a baking recipe, e.g., 
  \begin{enumerate}
