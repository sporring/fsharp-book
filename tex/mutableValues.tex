...
%
E.g., \lstinline![||]! is the empty array, \mbox{\lstinline![|1; 2; 3|]!} is an array of integers, \mbox{\lstinline![|"This"; "is"; "an"; "array"|]!} is an array of strings, and \mbox{\lstinline![|(fun x -> x); (fun x -> x*x)|]!} is an array of functions.  Arrays may also be given as ranges,
%
