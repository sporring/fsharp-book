...
%
For example, \lstinline![]! is the empty list, \mbox{\lstinline![1; 2; 3]!} is a list of integers, \mbox{\lstinline!["This"; "is"; "a"; "list"]!} is a list of strings, and since functions are also values, \mbox{\lstinline![(fun x -> x); (fun x -> x*x)]!} is a list of functions. Lists may also be given as ranges,
%
