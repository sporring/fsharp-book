...
\begin{figure}
  ...
  \caption{F# understands the function \lstinline{mul x y = x*y} not as a function of 2 floats but as a function from floats to the space of functions who in turn are functions from floats to floats.}
