...
%\def\@abstract#1{\noindent\textbf{\abstractname} #1\par\begin{center}\rule{0.8\textwidth}{0.5pt}\end{center}}
\DeclareRobustCommand\abstract{\@ifstar\@abstgobl\@abstract}
\def\abstract{\@ifnextchar[{\@abstractWith}{\@abstractWithout}}
\def\@abstractWithout#1{%
  \noindent\textbf{\abstractname} #1\newpage%\par\begin{center}\rule{0.8\textwidth}{0.5pt}\end{center}
}
\def\@abstractWith[#1]#2{%
%  \begin{minipage}{\linewidth} \centering \includegraphics[width=\linewidth]{#1}\end{minipage}\newpage%
  \@abstractWithout{#2}%
}
\makeatother
