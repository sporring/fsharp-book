...
\lstdefinelanguage{fsharp}{%
  morekeywords={let, new, match, with, rec, open, module, namespace, type, of, member, % 
    ...
    interface, inherit, finally, val, bool, int, byte, sbyte, int16, uin16, int32, uint32, int64, uint64, bigint, nativint, unativeint, float, double, single, float32, decimal, char, string, unit, var, from, select,
    where, order, by, elif },
