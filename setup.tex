...
\newcommand{\idxs}[1]{\marginpar{%$\cdot$~\parbox[t]{\linewidth}{\raggedright \expandarg\IfSubStr{#1}{@}{\StrBehind{#1}{@}}{#1}}
...
\newcommand{\advice}[1]{\hspace*{0mm}\marginpar{$\star$}\textbf{#1}}
\newcommand{\advanced}[1]{\hspace*{0mm}\marginpar{$\star$}\textbf{#1}}
