...
Many programming constructs need to be repeated. The most basic example is counting, e.g., from 1 to 10 with a \idx{\lstinline{for}}-loop,
%
\fso{count}{Counting from 1 to 10 using a \lstinline{for}-loop.}
%
...
%
\fs{countLightweight}{Counting from 1 to 10 using a \lstinline{for}-loop.}
%
