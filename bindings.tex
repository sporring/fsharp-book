...
\spec{Mono seems to have a bug, \texttt{printfn "\%.1g"   3.13;;} and \texttt{printfn "\%.1f"   3.13;;} produces different number of digits.}
\spec{Spec-4.0 \texttt{\%s} and \texttt{\%b} are missing in Section 3.1.16.}
