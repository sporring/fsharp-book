...
The \keyword{mutable} in \keyword{let} bindings means that the identifier may be rebound to a new value using the \idx{\lexeme{<-}} lexeme, e.g.,\jon{Discussion on heap and stack should be added here.}
%
\begin{verbatimwrite}{tmp.ebnf}
expr = ...
  | expr "<-" expr (*assingment*)
