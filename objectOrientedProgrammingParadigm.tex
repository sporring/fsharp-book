...
\end{description}
Aggregational and compositional relations are often called \idx{has-a} relations, since host objects have one or more guests either as aliases or as owners.
