...
%
\lstinputlisting[language=fsharp,label=gcd,numbers=left,caption={The greatest common divisor of 2 integers.},escapechar=|]{\src/gcd.fsx}
%
...
%
\lstinputlisting[language=fsharp,label=lexicalScopeTracing,numbers=left,caption={Example of lexical scope and closure environment.},escapechar=|]{\src/lexicalScopeTracing.fsx}
%
...
%
\lstinputlisting[language=fsharp,label=dynamicScopeTracing,numbers=left,caption={Example of dynamic scope and closure environment.},escapechar=|]{\src/dynamicScopeTracing.fsx}
%
