...
%
Extensions compared to \Cref{\ebnf/class.ebnf} are: \lstinline[language=syntax]{<*baseClassIdent*>} is the name of another class that this class optionally builds upon using the \lstinline{inherit} keyword. Members may be regular members using the \lstinline{member} keyword or other types of members indicated by the alternative keywords: \lstinline{abstract member}, \lstinline{default}, and \lstinline{override}.
