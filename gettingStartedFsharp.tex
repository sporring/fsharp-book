...
\begin{description}
\item[\lstinline[language=console]{.fs}] An \idx{implementation file}, e.g., \lstinline[language=console]{myModule.fs}
\item[\lstinline[language=console]{.fsi}] A \idx{signature file}, e.g., \lstinline[language=console]{myModule.fsi}
\item[\lstinline[language=console]{.fsx}] A \idx{script file}, e.g., \lstinline[language=console]{gettingStartedStump.fsx}
\item[\lstinline[language=console]{.fsscript}] Same as \lstinline[language=console]{.fsx}, e.g., \lstinline[language=console]{gettingStartedStump.fsscript}
\item[\lstinline[language=console]{.exe}] An \idx{executable file}, e.g., \lstinline[language=console]{gettingStartedStump.exe}
\end{description}
% \begin{table}
%   \centering
%   \begin{tabular}{|l|l|}
